...
<div id="Main" class="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-64 bg-gray-900 flex-col">
    ...
    <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
      ...
      <div data-menu="terreno-btn" class="hidden justify-start  flex-col w-full md:w-auto items-start pb-1 ">
        <a href="{{ route('terreno.create') }}" class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
          <x-bladewind.icon
            name="plus"
          />
    ...
    <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
      ...
      <div data-menu="fertilizacion-btn" class="hidden justify-start  flex-col w-full md:w-auto items-start pb-1 ">
        <a href="{{ route('fertilizacion.create') }}" class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
          <x-bladewind.icon
            name="plus"
          />
          <p class="text-base leading-4  ">Agregar</p>
        </a>
        <a href="{{ route('fertilizacion.index') }}" class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
          <x-bladewind.icon
            name="list-bullet"
          />
          <p class="text-base leading-4  ">Lista</p>
