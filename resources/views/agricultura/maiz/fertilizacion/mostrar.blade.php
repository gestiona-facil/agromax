...
@section('titulo', 'Fertilizacion')

@section('titulo-contenido', 'Datos de Fertilizacion: '.$modelo->agricultura->identificacion)

@section('contenido')
<div>
    <div class="p-b-2 pt-4 px-4">
        {{-- boton editar --}}
        <flow-button size="xs"><a href="{{ route('fertilizacion.edit', ['cosecha' => $modelo->id])}}">Editar</a></flow-button>
        {{-- boton exportar --}}
    </div>
