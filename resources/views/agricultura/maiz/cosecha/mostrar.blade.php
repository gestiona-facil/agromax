...
@section('titulo-contenido', 'Datos de Cosecha en: '.$modelo->siembra->terreno->ubicacion)
...
<div>
    <div class="p-b-2 pt-4 px-4 flex justify-between pt-6 pb-8">
        ...
        <x-bladewind.button
            tag="a" 
            size="tiny" href="{{ route('cosecha.edit', ['cosecha' => $modelo->id])}}"
            class="bg-green-700"
        >Editar</x-bladewind.button>
        {{-- boton exportar --}}
        <x-bladewind.button
            tag="a" 
            size="tiny" href="{{ route('agricultura.cosecha.exportar', ['cosecha' => $modelo->id ]) }}"
            class="!bg-amber-700"
        ...
        <div class="px-1 w-4/5">
            ...
            <div class="p-3">
                <div class="flex flex-row items-center py-3 justify-between">
                    <div class="w-1/2">
                        <p class="flex flex-col text-xl">
                            <span class="px-2">Siembra en: </span><span class="italic indent-6 text-2xl font-light">{{$modelo->siembra->terreno->ubicacion}}</span>
                        </p>
                    </div>
                    <div class="w-1/2">
                        <p class="flex flex-col text-xl">
                ...
                <div class="flex flex-row items-center py-3 justify-between">
                    <div class="w-1/2">
                        <p class="flex flex-col text-xl">
                            <span class="px-2">Cantidad cosechada: </span><span class="italic indent-6 text-2xl font-light">{{$modelo->cantidad}} Kg</span>
                        </p>
                    </div>
                </div>
            </div>
