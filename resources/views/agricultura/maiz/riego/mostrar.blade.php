...
@section('titulo-contenido', 'Datos de Vaca: '.$modelo->riego->identificacion)
                ...
                <div class="flex flex-row items-center py-3 justify-between">
                    <div>
                        <p class="flex text-xl">
                            <span class="px-2">Siembra </span><span class="italic text-2xl font-light">{{$modelo->siembra->identificacion}}</span>
                        </p>
                    </div>
                    <div>
                        <p class="flex text-xl">
